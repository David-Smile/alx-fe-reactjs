function Services() {
  return (
    <div style={{ padding: '40px 5vw', background: 'linear-gradient(90deg, #e0ffe0 60%, #b5ffd6 100%)', borderRadius: '16px', margin: '32px auto', maxWidth: '700px', minWidth: '0', boxShadow: '0 2px 12px rgba(50,205,50,0.07)', textAlign: 'center', width: '100%' }}>
